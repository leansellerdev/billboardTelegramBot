...
user_panel_kb_builder: ReplyKeyboardBuilder = ReplyKeyboardBuilder()
...
registered_buttons: list[KeyboardButton] = [KeyboardButton(text=value) for value in start_buttons_user_panel]
...
user_panel_kb_builder.row(*registered_buttons, width=3)
